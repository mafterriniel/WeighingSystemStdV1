...
Source: "TSI STANDARD SOFTWARE MANUAL.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "fonts\DS-DIGI.TTF"; DestDir: "{fonts}"; FontInstall: "DS-DIGITAL"; Flags: onlyifdoesntexist uninsneveruninstall
...
begin
   ...
   begin
    ...
    CRRuntimex86Desc:= 'CRRuntime_1340_x86';
    ...
    CRRuntimex64Desc:= 'CRRuntime_1340_x64';
