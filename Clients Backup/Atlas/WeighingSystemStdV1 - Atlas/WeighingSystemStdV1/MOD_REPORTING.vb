...
",(SELECT USER_DISPLAYNAME FROM USERACCOUNTS WHERE User_id = WeigherIn),* FROM OUTBOUND_TBL where RefNo = '" & refno & "'"
    ...
    Public Sub PrintToPrinter(ticketType As TicketTypeEnum, Optional ByVal refno As String = "", Optional ByVal WeigherOutNameActual As String = "")
        Try
            Dim SysSettings As New settings
            SysSettings.Load()
            ...
            RR.DataDefinition.FormulaFields.Item("WeigherOutNameActual").Text = "'" & WeigherOutNameActual & "'"
            RR.DataDefinition.FormulaFields.Item("unitweight").Text = "'" & SysSettings.UnitWeight & "'"
            RR.DataDefinition.FormulaFields.Item("DeductUnit").Text = "'" & SysSettings.DeductUnit & "'"
...
",(SELECT USER_DISPLAYNAME FROM USERACCOUNTS WHERE User_id = WeigherOut) as USER_DISPLAYNAME_2,* FROM OUTBOUND_TBL where RefNo = '" & refno & "'"
