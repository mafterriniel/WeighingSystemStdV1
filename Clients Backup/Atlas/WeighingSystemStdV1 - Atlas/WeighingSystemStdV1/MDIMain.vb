...
#Region "PROCEDURES"
    Public IPIndicator As New TcpClient
...
#End Region
    ...
    Private Sub BtnOperation_OnButtonClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnOperation.Click,
        BtnTrans.Click,
        BtnManagement.Click,
        BtnDatabase.Click,
        BtnCust.Click,
        ...
        Select Case sender.name
            ...
            Case BtnTrans.Name
                ...
                Dim frmT = New FrmTrans()
                OpenMainBUtton(FrmLogin.WeighingTransaction, frmT, sender, Me)
